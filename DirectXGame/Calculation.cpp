...
Vector3 Calculation::Multiply(const Vector3 &vector,const Matrix4x4 &matrix) {
	...
	Vector3 result;
	result.x = vector.x * matrix.m[0][0] + vector.y * matrix.m[2][0] + vector.z * matrix.m[2][0] + matrix.m[3][0]; 
	result.y = vector.x * matrix.m[0][1] + vector.y * matrix.m[2][1] + vector.z * matrix.m[2][1] + matrix.m[3][1];
	result.z = vector.x * matrix.m[0][2] + vector.y * matrix.m[2][2] + vector.z * matrix.m[2][2] + matrix.m[3][2];
	return result;
